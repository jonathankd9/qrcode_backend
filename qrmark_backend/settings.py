"""
Django settings for qrmark_backend project.
...
SECRET_KEY = 'django-insecure-j%*l#8$om-4#1lpi5b*e_lbcl_0vbzce3j27dw@0z#@q(3pj)o'
...
WSGI_APPLICATION = 'qrmark_backend.wsgi.application'
